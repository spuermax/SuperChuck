...
import com.developers.super_chuck.internal.helper.GsonConverter;
...
public class HttpTransaction {
    ...
    public void setRequestHeaders(List<HttpHeader> headers) {
        requestHeaders = GsonConverter.getInstance().toJson(headers);
    }

    public List<HttpHeader> getRequestHeaders() {
        return GsonConverter.getInstance().fromJson(requestHeaders,
    ...
    public void setResponseHeaders(List<HttpHeader> headers) {
        responseHeaders = GsonConverter.getInstance().toJson(headers);
    }

    public List<HttpHeader> getResponseHeaders() {
        return GsonConverter.getInstance().fromJson(responseHeaders,
                new TypeToken<List<HttpHeader>>(){}.getType());
    }
